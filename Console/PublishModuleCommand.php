...
namespace Modules\Products10\Console;
...
{
    //==============================================================================================
    protected $signature    = 'products10:publish';
    protected $description  = 'Publish package files and update module status.';
    //==============================================================================================
    protected string $moduleName        = 'Products10';
    protected string $moduleNameLower   = 'products10';
    //==============================================================================================
    ...
    public function handle(){
        $this->call('vendor:publish', ['--tag' => 'products10-module']);
        $this->call('vendor:publish', ['--tag' => 'products10-config']);
